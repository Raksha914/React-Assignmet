  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/PipelineTable" element={
          <MainLayout>
            <PipelineTable />
          </MainLayout>
        } />
        <Route path="/CampaignsTable" element={
          <MainLayout>
            <CampaignsTable />
          </MainLayout>
        } />
        ...
        <Route path="/EmailDashboard" element={
          <MainLayout>
            <Inbox />
          </MainLayout>
        } />
        ...
        <Route path="/ContactReport" element={
          <MainLayout>
            <ContactReport />
          </MainLayout>
        } />
        <Route path="/CompanyReport" element={
          <MainLayout>
            <CompanyReport />
          </MainLayout>
        } />
        <Route path="/DealReport" element={
          <MainLayout>
            <DealReport />
          </MainLayout>
        } />
